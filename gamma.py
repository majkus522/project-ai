...
#Load checkpoint
if os.path.isfile(f"checkpoint_gamma_{GAMMA}.pth"):
    checkpoint = torch.load(f"checkpoint_gamma_{GAMMA}.pth")
        ...
        while True:
            ...
            if done:
                if total_reward > best_reward:
                    ...
                    torch.save(best_game, f"best_game_gamma_{GAMMA}.pth")
                break
...
def replay_best_game():
    game_data = torch.load(f"checkpoint_gamma_{GAMMA}.pth", weights_only=False)
